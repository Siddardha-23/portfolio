...
# ------------------------------------------------------------------
# POST /api/resume/tailor — Full pipeline: extract JD → tailor → ATS scores
# ------------------------------------------------------------------
...
def tailor():
    ...
    try:
        ...
        result = get_resume_service().full_tailor_pipeline(jd_text)
        return jsonify(result), 200
    except ValueError as e:
        msg = str(e)
        code = 404 if "No resume uploaded" in msg or "not available" in msg else 400
