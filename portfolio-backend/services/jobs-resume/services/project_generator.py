...
class ProjectGenerator:
    ...
    def generate(
        ...
        prompt = (
            ...
            "own time — NOT another job. Sharing tech stack with the candidate's day-job\n"
            "experience is GOOD: it makes the project defensible, because the candidate can\n"
            "speak to it fluently in an interview.\n\n"
            "PROJECT MUST BE ALL THREE: defensible, JD-aligned, a DIFFERENT ACCOMPLISHMENT than experience.\n"
            ...
            "      answer rooted in the candidate's real skills. Reusing the candidate's day-job\n"
            "      tech stack here is encouraged — that's what makes it defensible.\n\n"
            ...
            "  (C) DIFFERENT ACCOMPLISHMENT — this is about the DELIVERABLE, not the tech.\n"
            "      Same tech stack as experience is fine and expected. What you MUST NOT do is\n"
            "      re-describe the same deliverable the candidate already claims credit for at\n"
            "      work. The test: if a reader compares the project to the experience bullets,\n"
            "      they should think 'these are two DIFFERENT pieces of work that happen to use\n"
            "      similar tools', not 'the project is just the work bullet again with a\n"
            "      different name'.\n"
            "      Examples of OK overlap (same tech, different accomplishment):\n"
            "        • Experience: 'Maintained Kafka telemetry ingestion at GE HealthCare.'\n"
            "          Project: 'Personal Kafka-based home-lab metric collector that aggregates\n"
            "          Raspberry Pi sensor data.' ← Same Kafka, but a different system the\n"
            "          candidate built for themselves. ALLOWED.\n"
            "        • Experience: 'Built ELK-based log alerting at HealthPlix.'\n"
            "          Project: 'Personal log-anomaly bot that watches my home server with\n"
            "          OpenSearch and posts alerts to Discord.' ← Same ELK family, different\n"
            "          system / different consumer / different scope. ALLOWED.\n"
            "      Examples of NOT OK (same accomplishment, just renamed):\n"
            "        • Experience: 'Built Kafka anomaly-detection pipeline for clinical devices\n"
            "          at GE.' Project: 'Clinical Device Anomaly Detection Engine using Kafka.'\n"
            "          ← This is the same deliverable. REJECTED.\n"
            "        • Experience: 'Built ELK log aggregation at HealthPlix.'\n"
            "          Project: 'Log Aggregation Pipeline using ELK.' ← Same deliverable.\n"
            "          REJECTED.\n"
            "      Rule of thumb: change the NOUN — the thing being built — not just the\n"
            ...
            "  STEP 2: Read the EXPERIENCE BULLETS block. List the DELIVERABLES the candidate\n"
            "          already claims at work (e.g. 'log aggregation pipeline', 'anomaly\n"
            "          detection engine for clinical devices'). You will NOT rebuild those same\n"
            "          deliverables — but you ARE allowed (encouraged) to reuse their tech.\n"
            "  STEP 3: Pick a personal/side project PURPOSE that uses the JD anchors (Step 1)\n"
            "          and is a DIFFERENT thing-being-built than the deliverables in Step 2.\n"
            "          Write the one-sentence purpose into 'purpose'.\n"
    ...
    def generate_batch(
        ...
        prompt = (
            ...
            "experience is GOOD: it makes the project defensible, because the candidate can\n"
            "speak to it fluently in an interview.\n\n"
            "EACH PROJECT MUST BE ALL THREE: defensible, JD-aligned, a DIFFERENT ACCOMPLISHMENT than experience.\n"
            ...
            "      Reusing the candidate's day-job tech stack here is encouraged — that's what\n"
            "      makes it defensible.\n\n"
            "  (B) JD-ALIGNED — the project must SHOWCASE the JD's required skills, not the\n"
            "      candidate's miscellaneous stack. Anchor the project's purpose to a problem\n"
            "      that NATURALLY USES the JD-required skills listed below. If the JD wants\n"
            ...
            "      Same tech stack as experience is fine and expected. What you MUST NOT do is\n"
            "      re-describe the same deliverable the candidate already claims credit for at\n"
            "      work. The test: a reader comparing the project to the experience bullets\n"
            "      should think 'these are two DIFFERENT pieces of work that happen to use\n"
            "      similar tools', not 'the project is just the work bullet again with a\n"
            "      different name'.\n"
            "      Examples of OK overlap (same tech, different accomplishment):\n"
            "        • Experience: 'Maintained Kafka telemetry ingestion at GE HealthCare.'\n"
            "          Project: 'Personal Kafka-based home-lab metric collector that aggregates\n"
            "          Raspberry Pi sensor data.' ← Same Kafka, different system. ALLOWED.\n"
            "        • Experience: 'Built ELK-based log alerting at HealthPlix.'\n"
            "          Project: 'Personal log-anomaly bot that watches my home server with\n"
            "          OpenSearch and posts alerts to Discord.' ← Same ELK family, different\n"
            "          system / consumer / scope. ALLOWED.\n"
            "      Examples of NOT OK (same accomplishment, just renamed):\n"
            "        • Experience: 'Built Kafka anomaly-detection pipeline for clinical devices\n"
            "          at GE.' Project: 'Clinical Device Anomaly Detection Engine using Kafka.'\n"
            "          ← Same deliverable. REJECTED.\n"
            "        • Experience: 'Built ELK log aggregation at HealthPlix.'\n"
            "          Project: 'Log Aggregation Pipeline using ELK.' ← Same deliverable.\n"
            "          REJECTED.\n"
            "      Rule of thumb: change the NOUN — the thing being built — not just the\n"
            ...
            "  STEP 2: Read the EXPERIENCE BULLETS block. List the DELIVERABLES the candidate\n"
            "          already claims at work (e.g. 'log aggregation pipeline', 'anomaly\n"
            "          detection engine for clinical devices'). You will NOT rebuild those\n"
            "          same deliverables — but you ARE allowed (encouraged) to reuse their tech.\n"
            "  STEP 3: Pick a personal/side project PURPOSE that uses the JD anchors (Step 1)\n"
            "          and is a DIFFERENT thing-being-built than the deliverables in Step 2.\n"
            "          Write the one-sentence purpose into 'purpose'.\n"
            "  STEP 4: Write the bullets — each must reference at least one JD-anchor skill\n"
